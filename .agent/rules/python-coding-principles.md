...
- Prefer writing meaningful, descriptive variable names with auxiliary verbs (e.g., is_active, has_permission) making them self-explanatory (the how), over comments (the why) and follow pep8 style documenting comments (the what).
